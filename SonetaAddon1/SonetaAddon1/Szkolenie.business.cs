...
[assembly: ModuleType("Szkolenie", typeof(SonetaAddon1.Szkolenie.SzkolenieModule), 4, "SonetaSzkolenie", 3, VersionNumber=1)]

namespace SonetaAddon1.Szkolenie {
	...
	public partial class SzkolenieModule : Module {
		...
		public abstract partial class LotTable : GuidedTable {
			...
			public partial class WgKodKey : Key<Lot> {
		...
		public abstract partial class LotRow : GuidedRow {
			...
			[ChildTable("Rezerwacja", "SonetaAddon1.Szkolenie.Rezerwacja", "Lot")]
			public SubTable<Rezerwacja> Rezerwacje => (SubTable<Rezerwacja>)Table.Module.Rezerwacje.WgLot.CreateSubTable(this);
		...
		public abstract partial class MaszynaTable : GuidedTable {
			...
			public partial class WgNrBocznyKey : Key<Maszyna> {
		...
		public abstract partial class MaszynaRow : GuidedRow {
			...
			[ChildTable("Rezerwacja", "SonetaAddon1.Szkolenie.Rezerwacja", "Maszyna")]
			public SubTable<Rezerwacja> Rezerwacje => (SubTable<Rezerwacja>)Table.Module.Rezerwacje.WgMaszyna.CreateSubTable(this);
		...
		public abstract partial class RezerwacjaTable : GuidedTable {
			...
			public partial class LotRelation : Key<Rezerwacja> {
			...
			public partial class MaszynaRelation : Key<Rezerwacja> {
			...
			public partial class KlientRelation : Key<Rezerwacja> {
			...
			public partial class WgNrRezerwacjiKey : Key<Rezerwacja> {
			...
			public partial class WgDatyKey : Key<Rezerwacja> {
	...
	public static class StaticsSzkolenieModule {
		...
		public static TResult Record<TResult>(this IRecordInvoker<Lot, TResult> row, Action<SzkolenieModule.LotRecord> action)
		    => row.InvokeAction(action, (rec, act) => ((Action<SzkolenieModule.LotRecord>)act)((SzkolenieModule.LotRecord)rec));

		public static TResult Record<TResult>(this IRecordInvoker<Maszyna, TResult> row, Action<SzkolenieModule.MaszynaRecord> action)
		    => row.InvokeAction(action, (rec, act) => ((Action<SzkolenieModule.MaszynaRecord>)act)((SzkolenieModule.MaszynaRecord)rec));

		public static TResult Record<TResult>(this IRecordInvoker<Rezerwacja, TResult> row, Action<SzkolenieModule.RezerwacjaRecord> action)
		    => row.InvokeAction(action, (rec, act) => ((Action<SzkolenieModule.RezerwacjaRecord>)act)((SzkolenieModule.RezerwacjaRecord)rec));
	}
